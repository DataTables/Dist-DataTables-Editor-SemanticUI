# Editor for DataTables with styling for [SemanticUI](https://semantic-ui.com/)

This is the distribution package for the [Editor extension](https://datatables.net/extensions/editor) for [DataTables](https://datatables.net/) with styling for [SemanticUI](https://semantic-ui.com/).
...
npm install datatables.net-editor-se
```
